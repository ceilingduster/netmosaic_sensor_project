...
CFLAGS := -std=c11 -O2 -Wall -Wextra -Wno-unused-parameter $(NDPI_DEFINES) -I. -Iinclude \
	...
	-Ilibs/nDPI-4.6/src/include \
	-Ilibs/lua/src

LDFLAGS := -Llibs/nDPI-4.6/src/lib -Llibs/windivert/x64 -Lbuild/lua
...
$(TARGET): $(OBJS) $(LUA_BUILD_DIR)/liblua.a
	...
	[ -f libs/nDPI-4.6/src/lib/libndpi.a ] && cp -f libs/nDPI-4.6/src/lib/libndpi.a $(DIST_STATIC_DIR)/ || true
